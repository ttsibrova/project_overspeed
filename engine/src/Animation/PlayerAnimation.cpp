...
void PlayerAnimation::draw (const geom::Point2D& playerPos, const geom::Vector2D& playerVelocity)
{
    ...
    textureManager.DrawRotated (graphics::getTextureId (graphics::PlayerSprite::BodyPointer), pointerPos, pointerSpriteInfo.width, pointerSpriteInfo.height, pointerOrigin, rotationPointer);
